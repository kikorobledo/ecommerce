<div>
    ...
    <div class="container py-12">
        ...
        <x-jet-form-section submit="save" class="mb-6">
            ...
            <x-slot name="title">Agregar un nuevo distrito</x-slot>

            <x-slot name="description">Complete la información para agregar un distrito</x-slot>
        ...
        <x-jet-action-section>
            ...
            <x-slot name="description">
                Aquí encontrara todas los distritos
            </x-slot>
                    ...
                    <tbody class="divide-y divide-gray-300">
                        ...
                        @foreach($districts as $district)
                            ...
                            <tr>
                                <td class="py-2">
                                    {{ $district->name }}
                                    {{-- <a href="#" class="uppercase underline hover:text-blue-600"></a> --}}
                                </td>
                                <td >
                                    <div class="flex divide-x divide-gray-300 font-semibold">
                                        <a href="#" wire:click="edit('{{ $district->id }}')" class="pr-2 hover:text-blue-600 cursor-pointer">Editar</a>
                                        <a href="#" wire:click="$emit('deleteDistrict', '{{ $district->id }}')" class="pl-2 hover:text-red-600 cursor-pointer">Eliminar</a>
                                    </div>
                                </td>
                            </tr>
