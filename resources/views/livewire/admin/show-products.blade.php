<div>
    ...
    <x-slot name="header">
        ...
        <div class="flex items-center">
            ...
            <h2 class="font-semibold text-gray-800 text-xl">Lista de productos</h2>

            <x-button-enlace color="red" class="ml-auto" href="{{ route('admin.products.create')}}">Agregar Producto</x-button-enlace>
