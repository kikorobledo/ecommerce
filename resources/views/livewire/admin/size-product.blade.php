<div>
    ...
    <div class="bg-white shadow-xl rounded-lg p-6 mt-12">
        ...
        <div>
            ...
            <x-jet-input type="text" placeholder="Ingrese una talla" class="w-full" wire:model="name"></x-jet-input>
        ...
        @foreach($sizes as $size)
            ...
            <li class="bg-white shadow-lg rounded-lg p-6" wire:key="size-{{ $size->id}}">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-auto">
                        <x-jet-button wire:click="edit({{ $size->id }})" wire:loading.attr="disabled" wire:target="edit({{ $size->id }})"><i class="fas fa-edit"></i></x-jet-button>
                        <x-jet-button wire:click="$emit('deleteSize', {{ $size->id }})"><i class="fas fa-trash"></i></x-jet-button>
                    </div>
