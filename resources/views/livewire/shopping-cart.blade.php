        ...
        <div class="bg-white rounded-lg shadow-lg px-6 py-4 mt-4">
            ...
            <div class="flex justify-between items-center">
                ...
                <div>
                    ...
                    <p class="text-gray-700 font-bold text-lg"><span>Total: </span> USD {{ Cart::subTotal() }}</p>

                </div>

                <div>

                    <x-button-enlace href="{{ route('orders.create') }}" color="orange">Continuar</x-button-enlace>
