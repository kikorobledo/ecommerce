            ...
            <ul>
                ...
                @foreach($orders as $order)
                    ...
                    <li class="">
                        ...
                        <a href="{{ route('orders.show', $order) }}" class="py-2 px-4 hover:bg-gray-100 flex items-center">
                            ...
                            <span class="w-12 text-center">
                                ...
                                @switch($order->status)
                                    ...
                                    @case(5)
                                        <i class="fas fa-times-cirlcle text-green-500 opacity-50"></i>
                                        @break
