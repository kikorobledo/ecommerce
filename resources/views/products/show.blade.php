        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flexslider">
                  ...
                  <div class="text-trueGray-700 -mt-10">
            ...
            <div class="">
                ...
                <h1 class="text-xl text-trueGray-700 font-bold">{{ $product->name }}</h1>

                <div class="flex space-x-6">

                    <p class="text-trueGray-700">Marca: <a class="underline capitalize hover:text-orange-500" href="#">{{ $product->brand->name }}</a></p>

                    <p class="text-trueGray-700"> 5 <i class="fa fa-star text-yellow-400 text-sm"></i></p>
                ...
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    ...
                    <div class="p-4 flex items-center">
                        ...
                        <span class="flex items-center justify-center h-10 w-10 rounded-full bg-greenLime-600 text-white">
